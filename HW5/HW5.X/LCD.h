...
void LCD_drawChar(unsigned short, unsigned short, unsigned char); // print a character to the screen
void LCD_drawString(unsigned short, unsigned short, unsigned char*); // print a string to screen
